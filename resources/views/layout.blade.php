...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/assets/images/library.ico">
    <!-- Pignose Calender -->
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.html">
                    <b class="logo-abbr"><img src="/assets/images/knowledge.png" alt=""> </b>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/dashboard/create">Tambah Buku Baru</a></li>
                            <li><a href="/dashboard/verification">Verifikasi Anggota</a></li>
                            <li><a href="/dashboard/history">Riwayat Transaksi</a></li>
                            <!-- <li><a href="./index-2.html">Home 2</a></li> -->
                        </ul>
                    </li>
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa-solid fa-bell-concierge"></i><span class="nav-text">Layanan</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/dashboard/lend">Peminjaman</a></li>
                            <li><a href="/dashboard/return">Pengembalian</a></li>
                    </li>
                </ul>
            </div>
        </div>
